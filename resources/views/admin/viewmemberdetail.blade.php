...
@section('content')
<div class="pagetitle">
  <h1>Robotic Club Member Profile</h1>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
      <li class="breadcrumb-item"><a href="{{ route('viewmember') }}">Manage Member</a></li>
            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade show active profile-overview" id="profile-overview">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{ $user->members->matricNum }}</div>
                  </div>
