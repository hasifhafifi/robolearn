          ...
          <div class="card-body">
             ...
             <form method="POST" action="{{ route('createReport') }}" enctype="multipart/form-data">
              ...
              <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" id="reportname" name="reportname" value="{{ old('reportname') }}">
                @error('reportname')
              ...
              <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" id="tourname" name="tourname" value="{{ old('tourname') }}">
                @error('tourname')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
              </div>
              <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" id="totalmarks" name="totalmarks" value="{{ old('totalmarks') }}">
                @error('totalmarks')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
              </div>
              <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" id="checkpoints" name="checkpoints" value="{{ old('checkpoints') }}">
                @error('checkpoints')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
              </div>
              <div class="form-group mb-3">
                ...
                <input type="radio" class="form-check-input" id="passobjective" name="objective" value="1" checked>
                <label for="passobjective">Pass</label><br>
                <input type="radio" class="form-check-input" id="failobjective" name="objective" value="0">
                <label for="failobjective">Fail</label>
              </div>
              <div class="form-group mb-3">
                <label for="commentdesc">Comment:</label>
                <textarea name="commentdetail" id="commentdetail" class="form-control" value="{{ old('commentdetail') }}" style="display:none"></textarea>
